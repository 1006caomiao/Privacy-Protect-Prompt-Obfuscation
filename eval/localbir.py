...
def call_chat_completion(
    ...
    *,
    ...
    try:
        ...
        result = text.split("[unused17]", 1)[1]  # </think>
        # print("*******", result)
        return result
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--input_file", type=str, default="./shuffling/results/delta/1/progressive/ai4privacy_NER.jsonl", help="混淆样本生成结果 JSONL")
    parser.add_argument("--output_dir", type=str, default="./eval/delta_qwen0.6b/1/ai4privacy_NER", help="评估结果输出目录")

    parser.add_argument("--api_key", type=str, default="", help="大模型 API Key") 
    parser.add_argument("--api_base", type=str, default="")
    parser.add_argument("--model", type=str, default="pangu_embedded_7b", help="模型名称")
    parser.add_argument("--system_prompt", type=str, default=DEFAULT_SYSTEM_PROMPT, help="系统指令")
    parser.add_argument("--num_fake_per_record", type=int, default=5, help="每条记录使用的伪样本数量")
    parser.add_argument(
        "--max_eval_records",
        type=int,
        default=200,
