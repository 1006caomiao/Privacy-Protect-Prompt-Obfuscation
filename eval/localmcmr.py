...
def call_chat_completion(
    ...
    *,
    ...
    try:
        ...
        result = text.split("</think>", 1)[1]  # </think>, [unused17]
        # print("*******", result)
        return result
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--input_file", type=str, default="./shuffling/qwen/qwen8b/gqs/synthetic_NER/gqs_generation_results.jsonl", help="混淆样本生成结果 JSONL")
    parser.add_argument("--output_dir", type=str, default="./eval/qwen/qwen8b/synthetic_NER", help="评估结果输出目录")
    parser.add_argument("--api_key", type=str, default="", help="大模型 API Key") 
    parser.add_argument("--api_base", type=str, default="")
    parser.add_argument("--model", type=str, default="DeepSeek-R1-Distill-Llama-70B", help="模型名称")
    parser.add_argument("--system_prompt", type=str, default=DEFAULT_SYSTEM_PROMPT, help="系统指令")
    parser.add_argument("--num_fake_per_record", type=int, default=9, help="每条记录使用的伪样本数量")
    parser.add_argument(
...
def main() -> None:
    ...
    client = OpenAI(base_url=args.api_base, api_key=args.api_key, timeout=6000.0)
